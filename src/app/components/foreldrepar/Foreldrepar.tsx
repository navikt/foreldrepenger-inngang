...
const Foreldrepar: React.StatelessComponent<Props> = ({
    firstParent,
    secondParent,
    variant
}) => {
    const firstSvg = require(`../../assets/foreldre/${firstParent}.svg`)
        .default;
    const secondSvg = require(`../../assets/foreldre/${secondParent}.svg`)
        .default;
    ...
    return (
        <div role="presentation" className={cls.className}>
            ...
            {variant &&
                variant === 3 && (
                    <span className={cls.element('parentSeparator')} />
                )}
