...
import NavigationBox from '../components/frontpage/NavigationBox';
import ButtonPanel from '../components/frontpage/ButtonPanel';
        ...
        <div className="frontpage">
            ...
            <div className="content">
                <NavigationBox title={translate('foreldrepenger')}>
                    ...
                    <Tekstomrade>
                        {translate('foreldrepenger_unntak')}
                    </Tekstomrade>
                    <div className="space-after-explanation" />
                    <ButtonPanel
