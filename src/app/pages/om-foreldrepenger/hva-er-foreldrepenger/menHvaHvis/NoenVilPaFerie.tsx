                        ...
                        <g id="Stacked-Group" transform="translate(0.000000, 59.000000)">
                            <g id="Toggle/av">
                                ...
                                <g
                                    ...
                                    <g
                                        id="Icons/vacation/outline/blue"
                                        ...
                                        />
                                        <path
                                            d="M11.6055,1.6245 C6.7275,3.5575 3.5605,7.1105 4.9845,10.7035 L5.3525,11.6335 L7.6765,10.7115 L8.2385,9.4135 L9.5365,9.9755 L18.8325,6.2905 L19.3935,4.9935 L20.6915,5.5535 L23.0155,4.6325 L22.6475,3.7025 C21.2225,0.1085 16.4825,-0.3085 11.6055,1.6245 L11.6055,1.6245 Z"
                                            id="Stroke-8247"
                                        />
                                        <path
                                            d="M23.5,22.5 C22.5,22.5 21.5,21.604 21.5,20.5 C21.5,21.604 20.5,22.5 19.5,22.5 C18.5,22.5 17.5,21.604 17.5,20.5 C17.5,21.604 16.5,22.5 15.5,22.5 C14.5,22.5 13.5,21.604 13.5,20.5 C13.5,21.604 12.5,22.5 11.5,22.5 C10.5,22.5 9.5,21.604 9.5,20.5 C9.5,21.604 8.5,22.5 7.5,22.5 C6.5,22.5 5.5,21.604 5.5,20.5 C5.5,21.604 4.5,22.5 3.5,22.5 C2.5,22.5 1.5,21.604 1.5,20.5 C1.5,21.19 1.037,21.799 0.5,22.159"
                                            id="Stroke-8248"
                                        />
                                    </g>
                                </g>
