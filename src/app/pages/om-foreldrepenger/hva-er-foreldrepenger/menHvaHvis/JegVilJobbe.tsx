                            ...
                            <g
                                ...
                                <g
                                    ...
                                    <g
                                        ...
                                        />
                                        <path
                                            d="M16.5,7.5 L21.5,7.5"
                                            id="Stroke-8033"
                                        />
                                        <path
                                            d="M16.5,9.5 L21.5,9.5"
                                            id="Stroke-8034"
                                        />
                                        <path
                                            d="M16.5,11.5 L21.5,11.5"
                                            id="Stroke-8035"
                                        />
                                        <path
                                            d="M16.5,13.5 L21.5,13.5"
                                            id="Stroke-8036"
                                        />
                                        <path
                                            d="M16.5,15.5 L21.5,15.5"
                                            id="Stroke-8037"
                                        />
                                        <path
                                            d="M16.5,17.5 L21.5,17.5"
                                            id="Stroke-8038"
                                        />
                                        <path
                                            d="M16.5,19.5 L21.5,19.5"
                                            id="Stroke-8039"
                                        />
                                        <path
                                            d="M2.5,12.5 L9.5,12.5"
                                            id="Stroke-8040"
                                        />
                                        <path
                                            d="M2.5,15.5 L9.5,15.5"
                                            id="Stroke-8041"
                                        />
                                        <path
                                            d="M2.5,18.5 L9.5,18.5"
                                            id="Stroke-8042"
                                        />
                                        <path
                                            d="M4.5,5.5 L7.5,5.5"
